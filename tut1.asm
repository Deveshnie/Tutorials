...
5)
import numpy as np
z=[ 10,30,100,300,1000]  			#determines the number of evenly spaced numbers between 0 and pi/2 
...
The error becomes smaller when more points are taken between 0 and pi/2. The error in this case scales as,
